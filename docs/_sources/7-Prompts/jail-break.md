...
在 OpenAI 的论文[The Instruction Hierarchy: Training LLMs to Prioritize Privileged Instructions](https://arxiv.org/abs/2404.13208)中，引入了一个包含四个优先级级别的指令层次结构，如下图所示：
